...
public class EntityEmptyConstructorTest {
    ...
    @Test
    public void test() {
        String[] fileNames = new File(System.getProperty("user.dir") + "/src/main/java/com/a11/schedule/entity").list();
    ...
    private Class getClass(String className) {
        try {
            return Class.forName("com.a11.schedule.entity." + className);
